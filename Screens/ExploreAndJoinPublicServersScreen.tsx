...
const JoinServerScreen = ({route}) => {
    const [codeInput, setCodeInput] = useState('');

    const subjects = [
        {
            subject: "ACT/SAT Exams"
        },
        {
            subject: "Athletics"
        },
        {
            subject: "Academic Extracurriculars"
        },
        {
            subject: "AP Exams"
        },
        ...
        {
            subject: "Planning for College"
        },
        {
            subject: "Planning for High School"
        },
    ]
                ...
                ListHeaderComponent={
                    <View style={{ alignItems: "center" }}>
                        ...
                        <Text style={[styles.subHeadingText, { marginBottom: 20 }]} >
                            Welcome to the server explorer! Below is a list for categories of different communities.
                        </Text>
                    </View>
                }
